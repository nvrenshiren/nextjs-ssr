...
class helpCouponPage extends React.Component {
  ...
  render() {
    return (
      <HtmlComponents title="帮助中心-加息券说明">
        <HelpLayout>
          <Divider orientation="left">加息券说明</Divider>
          <Collapse
            bordered={false}
            defaultActiveKey={['0']}
            expandIcon={({ isActive }) => (
          ...
          >
            {helpQuestions.coupon.map((item, index) => {
              return (
                <Panel
