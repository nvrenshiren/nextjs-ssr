...
class helpBindCardPage extends React.Component {
  ...
  render() {
    return (
      <HtmlComponents title="帮助中心-绑卡">
        <HelpLayout>
          <Divider orientation="left">绑卡</Divider>
          ...
          >
            {helpQuestions.bindcard.map((item, index) => {
              return (
                <Panel
...
export default helpBindCardPage
