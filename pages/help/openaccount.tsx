...
class helpOpenAccountPage extends React.Component {
  ...
  render() {
    return (
      <HtmlComponents title="帮助中心-开户">
        <HelpLayout>
          <Divider orientation="left">开户</Divider>
          ...
          >
            {helpQuestions.openaccount.map((item, index) => {
              return (
                <Panel
...
export default helpOpenAccountPage
