...
class helpRechargePage extends React.Component {
  ...
  render() {
    return (
      <HtmlComponents title="帮助中心-充值">
        <HelpLayout>
          <Divider orientation="left">充值</Divider>
          ...
          >
            {helpQuestions.recharge.map((item, index) => {
              return (
                <Panel
...
export default helpRechargePage
